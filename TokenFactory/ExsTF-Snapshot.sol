...
contract ERC20Exs is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {

    bool public pausable;
    bool public burnable;
    bool public mintable;

    constructor(string memory _name, string memory _symbol, uint _premint, bool _mintable, bool _pausable, bool _burnable) ERC20(_name, _symbol) {
        pausable=_pausable;
        burnable=_burnable;
        mintable=_mintable;
